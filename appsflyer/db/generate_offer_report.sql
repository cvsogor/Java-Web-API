DROP PROCEDURE IF EXISTS generate_offer_report;
DELIMITER //

CREATE PROCEDURE generate_offer_report(start_date date, end_date date)
BEGIN
select 
	'',
    A.offer_name,
