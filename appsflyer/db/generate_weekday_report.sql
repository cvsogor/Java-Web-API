DROP PROCEDURE IF EXISTS generate_weekday_report;
DELIMITER //

CREATE PROCEDURE generate_weekday_report(start_date date, end_date date)
BEGIN
select 
	cast(A.install_time as CHAR(1)) 'install_weekday', 
    A.offer_name,
