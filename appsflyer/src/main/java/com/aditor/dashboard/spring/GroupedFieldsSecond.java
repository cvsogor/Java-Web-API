...
/**
 * Created by detan on 12/12/15.
 */
public class GroupedFieldsSecond implements  Comparable<GroupedFieldsSecond>{
    ...
    public GroupedFieldsSecond(Date installTime, String offerName, String agency, String mediaSource, String country){
    ...
    @Override
    public int compareTo(GroupedFieldsSecond o) {
        GroupedFieldsSecond gf1 = this;
        GroupedFieldsSecond gf2 = o;
    ...
    public boolean equals(Object o) {
        ...
        GroupedFieldsSecond that = (GroupedFieldsSecond) o;
